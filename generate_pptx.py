...
def _apply_premium_styling(prs, data, client_name):
    ...
    # Section labels par slide (apparaitront comme tag visible en haut)
    SECTION_LABEL = {
        3: "INTRODUCTION", 4: "SITE", 5: "CONTEXTE",
        6: "SCENARIO A — INTENSIFICATION", 7: "SCENARIO A — FINANCIER", 8: "SCENARIO A — RISQUES",
        9: "SCENARIO B — EQUILIBRE", 10: "SCENARIO B — FINANCIER", 11: "SCENARIO B — RISQUES",
        12: "SCENARIO C — PRUDENT", 13: "SCENARIO C — FINANCIER", 14: "SCENARIO C — RISQUES",
        15: "COMPARATIF", 16: "ARBITRAGE STRATEGIQUE",
        17: "CONDITIONS DE REUSSITE", 18: "CE QU'ON NE VOIT PAS ENCORE",
    ...
    for idx, slide in enumerate(prs.slides):
        ...
        try:
            ...
            tf.margin_top = _Emu(0); tf.margin_bottom = _Emu(0)
            tf.word_wrap = False
            p = tf.paragraphs[0]
