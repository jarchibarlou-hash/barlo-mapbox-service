...
function makeStubs(opts) {
  ...
  return {
    ...
    "@supabase/supabase-js": {
      createClient: () => {
        if (opts && opts.supabaseThrows) throw new Error(opts.supabaseThrows);
...
function loadServer(exportNames, opts) {
  ...
  const env = Object.assign({}, process.env, { PORT: "0" },
    opts && (opts.supabase || opts.supabaseThrows) ? { SUPABASE_URL: "http://fake", SUPABASE_SERVICE_ROLE_KEY: "fake" } : {});
