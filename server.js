...
app.get("/health", (req, res) => res.json({ ok: true, engine: "browserless-mapbox-gl-3d", version: "73.0.1-program-driven" }));
...
app.listen(PORT, () => {
  console.log(`BARLO v73.0.1-program-driven on port ${PORT}`);
