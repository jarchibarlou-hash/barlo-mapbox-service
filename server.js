...
app.get("/health", (req, res) => res.json({ ok: true, engine: "browserless-mapbox-gl-3d", version: "38.0-roads-blocks-empty-parcel" }));
...
app.post("/generate", async (req, res) => {
  const t0 = Date.now();
  console.log("═══ /generate v38 (roads + blocks + empty parcel) ═══");
...
app.listen(PORT, () => {
  console.log(`BARLO v38 on port ${PORT}`);
