...
app.get("/health", (req, res) => res.json({ ok: true, engine: "browserless-mapbox-gl-3d", version: "40.0-softgreen-final" }));
...
app.post("/generate", async (req, res) => {
  const t0 = Date.now();
  console.log("═══ /generate v40 FINAL ═══");
...
app.listen(PORT, () => {
  console.log(`BARLO v40 on port ${PORT}`);
