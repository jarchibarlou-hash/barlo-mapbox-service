  ...
  map.on('style.load', () => {
    ...
    map.addLayer({
      ...
      layout: {
        ...
        'text-max-angle': 30, 'symbol-placement': 'line',
        'text-padding': 10, 'text-letter-spacing': 0.05,
      },
      paint: {
        'text-color': '#7a6a50',
...
// ─── OVERLAYS CANVAS — légende + boussole + arc solaire ─────────────────────
...
app.post("/generate", async (req, res) => {
  ...
  try {
    ...
    // Compositing base — 1280×1280 sans bande stats
    const W = 1280, H = 1280;
